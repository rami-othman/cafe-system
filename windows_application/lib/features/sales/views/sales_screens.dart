...
class _EditLine { _EditLine({required this.productId, this.variantId, String quantity = '1', String unitPrice = '0', String? discountValue}) : quantity = TextEditingController(text: quantity), unitPrice = TextEditingController(text: unitPrice), discountValue = TextEditingController(text: discountValue ?? ''); int productId; int? variantId; final TextEditingController quantity; final TextEditingController unitPrice; final TextEditingController discountValue; void dispose() { quantity.dispose(); unitPrice.dispose(); discountValue.dispose(); } }
