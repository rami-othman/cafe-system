...
class SalesInvoice {
  const SalesInvoice({required this.id, required this.invoiceNumber, required this.customerId, required this.customerName, required this.branchId, required this.branchName, required this.invoiceDate, required this.dueDate, required this.status, required this.subtotal, required this.taxTotal, required this.total, required this.allowedActions, this.isWalkIn = false, this.reference, this.notes, this.grossSubtotal, this.lineDiscountTotal, this.invoiceDiscountType, this.invoiceDiscountValue, this.invoiceDiscountTotal, this.additionalChargesTotal, this.manualAdjustment, this.createdBy, this.accountingStatus, this.paymentStatus, this.journalReference, this.receivableAmount, this.paidAmount, this.remainingAmount, this.isOverdue = false, this.creditedAmount, this.creditStatus, this.lines = const <SalesInvoiceLine>[], this.charges = const <SalesInvoiceCharge>[], this.collections = const <CustomerPaymentCollection>[], this.creditNotes = const <InvoiceCreditNoteEntry>[], this.refundedAmount, this.netCollectedAmount, this.remainingRefundableAmount});
  final int id; final String invoiceNumber; final int customerId; final String customerName; final int branchId; final String branchName; final String invoiceDate; final String? dueDate; final String status; final String subtotal; final String taxTotal; final String total; final Map<String, bool> allowedActions; final bool isWalkIn; final String? reference; final String? notes; final String? grossSubtotal; final String? lineDiscountTotal; final String? invoiceDiscountType; final String? invoiceDiscountValue; final String? invoiceDiscountTotal; final String? additionalChargesTotal; final String? manualAdjustment; final String? createdBy; final String? accountingStatus; final String? paymentStatus; final String? journalReference; final String? receivableAmount; final String? paidAmount; final String? remainingAmount; final bool isOverdue; final String? creditedAmount; final String? creditStatus; final List<SalesInvoiceLine> lines; final List<SalesInvoiceCharge> charges; final List<CustomerPaymentCollection> collections; final List<InvoiceCreditNoteEntry> creditNotes; final String? refundedAmount; final String? netCollectedAmount; final String? remainingRefundableAmount;
