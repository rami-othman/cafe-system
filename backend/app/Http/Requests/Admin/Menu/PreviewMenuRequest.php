...
class PreviewMenuRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'at' => ['nullable', 'date'], 'language' => ['nullable', Rule::in(['default', 'ar', 'en'])],
            'includeUnavailable' => ['nullable', 'boolean'], 'includeHidden' => ['nullable', 'boolean'],
