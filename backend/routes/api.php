...
use App\Http\Controllers\Api\FinanceCustomerController;
...
use App\Http\Controllers\Api\InvoiceTypeCatalogController;
...
Route::prefix('v1')->group(function (): void {
    ...
    Route::middleware(['api.token', 'password.changed', 'branch.access'])->group(function (): void {
        ...
        Route::prefix('finance')->group(function (): void {
            ...
            Route::get('invoice-groups', [InvoiceTypeCatalogController::class, 'groups'])->middleware('finance.permission:finance.settings.view');
            Route::post('invoice-groups', [InvoiceTypeCatalogController::class, 'storeGroup'])->middleware('finance.permission:finance.settings.manage');
            Route::patch('invoice-groups/{group}', [InvoiceTypeCatalogController::class, 'updateGroup'])->middleware('finance.permission:finance.settings.manage');
            Route::get('invoice-types', [InvoiceTypeCatalogController::class, 'types'])->middleware('finance.permission:finance.settings.view');
            Route::post('invoice-types', [InvoiceTypeCatalogController::class, 'storeType'])->middleware('finance.permission:finance.settings.manage');
            Route::patch('invoice-types/{type}', [InvoiceTypeCatalogController::class, 'updateType'])->middleware('finance.permission:finance.settings.manage');
            ...
            Route::get('customers', [FinanceCustomerController::class, 'index'])->middleware('finance.permission:finance.customers.view');
            Route::post('customers', [FinanceCustomerController::class, 'store'])->middleware('finance.permission:finance.customers.create');
            Route::get('customers/{customer}', [FinanceCustomerController::class, 'show'])->middleware('finance.permission:finance.customers.view');
            Route::patch('customers/{customer}', [FinanceCustomerController::class, 'update'])->middleware('finance.permission:finance.customers.edit');
            ...
            Route::patch('purchase-receipts/{receipt}', [PurchaseReceiptController::class, 'update'])->middleware('finance.permission:finance.purchases.receive');
            Route::post('purchase-receipts/{receipt}/post', [PurchaseReceiptController::class, 'post'])->middleware('finance.permission:finance.purchases.receive');
            ...
            Route::get('sales-invoices/{invoice}', [SalesInvoiceController::class, 'show'])->middleware('finance.permission:finance.sales.view');
            Route::patch('sales-invoices/{invoice}', [SalesInvoiceController::class, 'update'])->middleware('finance.permission:finance.sales.edit');
            Route::post('sales-invoices/{invoice}/cancel', [SalesInvoiceController::class, 'cancel'])->middleware('finance.permission:finance.sales.edit');
            Route::post('sales-invoices/{invoice}/post', [SalesInvoiceController::class, 'post'])->middleware('finance.permission:finance.sales.post');
            Route::post('sales-invoices/{invoice}/post-and-collect', [CustomerPaymentController::class, 'postAndCollect'])->middleware('finance.permission:finance.sales.post');
            Route::get('customers-receivables', [CustomerPaymentController::class, 'receivablesOverview'])->middleware('finance.permission:finance.customer_payments.view');
            Route::get('customers/{customer}/receivables', [CustomerPaymentController::class, 'customerReceivables'])->middleware('finance.permission:finance.customer_payments.view');
            Route::get('customer-payments', [CustomerPaymentController::class, 'index'])->middleware('finance.permission:finance.customer_payments.view');
            Route::post('customer-payments/preview', [CustomerPaymentController::class, 'preview'])->middleware('finance.permission:finance.customer_payments.create');
            Route::post('customer-payments', [CustomerPaymentController::class, 'store'])->middleware('finance.permission:finance.customer_payments.create');
            Route::get('customer-payments/{payment}', [CustomerPaymentController::class, 'show'])->middleware('finance.permission:finance.customer_payments.view');
            Route::post('customer-payments/{payment}/reverse', [CustomerPaymentController::class, 'reverse'])->middleware('finance.permission:finance.customer_payments.reverse');
            Route::get('sales-invoices/{invoice}/returnable-lines', [SalesCreditNoteController::class, 'returnableLines'])->middleware('finance.permission:finance.sales_credit_notes.view');
            Route::get('sales-credit-notes', [SalesCreditNoteController::class, 'index'])->middleware('finance.permission:finance.sales_credit_notes.view');
            Route::post('sales-credit-notes', [SalesCreditNoteController::class, 'store'])->middleware('finance.permission:finance.sales_credit_notes.create');
            Route::get('sales-credit-notes/{creditNote}/posting-preview', [SalesCreditNoteController::class, 'postingPreview'])->middleware('finance.permission:finance.sales_credit_notes.post');
            Route::get('sales-credit-notes/{creditNote}', [SalesCreditNoteController::class, 'show'])->middleware('finance.permission:finance.sales_credit_notes.view');
            Route::post('sales-credit-notes/{creditNote}/cancel', [SalesCreditNoteController::class, 'cancel'])->middleware('finance.permission:finance.sales_credit_notes.create');
            Route::post('sales-credit-notes/{creditNote}/post', [SalesCreditNoteController::class, 'post'])->middleware('finance.permission:finance.sales_credit_notes.post');
            Route::get('customers/{customer}/credit', [CustomerRefundController::class, 'customerCredit'])->middleware('finance.permission:finance.customer_refunds.view');
            Route::get('customer-refunds', [CustomerRefundController::class, 'index'])->middleware('finance.permission:finance.customer_refunds.view');
            Route::post('customer-refunds/preview', [CustomerRefundController::class, 'preview'])->middleware('finance.permission:finance.customer_refunds.create');
            Route::post('customer-refunds', [CustomerRefundController::class, 'store'])->middleware('finance.permission:finance.customer_refunds.create');
            Route::get('customer-refunds/{refund}', [CustomerRefundController::class, 'show'])->middleware('finance.permission:finance.customer_refunds.view');
